...
/**
 * This is the model class for table "professional_areas".
 *
 * The followings are the available columns in table 'professional_areas':
 * @property integer $id
 ...
 */
class ProfessionalAreas extends CActiveRecord
{
	/**
	 ...
	 * @return ProfessionalAreas the static model class
	 */
